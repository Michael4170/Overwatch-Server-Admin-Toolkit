...
Add your Identity UID with tier 3 (Owner), restart, done.

Full documentation, command list and configuration guide: [GitHub link]
Compatibility
...
Roadmap
In-game admin menu with spectate mode, scheduled restart warnings, MOTD on join, and Discord webhook logging are in active development. Suggestions and bug reports welcome via [GitHub/Discord link].
